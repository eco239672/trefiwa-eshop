      ...
      <div className="flex-grow max-w-7xl mx-auto w-full px-6 py-16">
        <section className="text-center max-w-4xl mx-auto mb-16">
          ...
          <p className="text-lg md:text-xl text-[#6B6E56] leading-relaxed">
            Silné, povzbudivé a plné chuti. Ideálna voľba pre perfektné naštartovanie vášho dňa.
          </p>
        </section>
        ...
        {isLoading ? (
          <p className="text-center text-[#A3A697] py-10">Načítavam produkty...</p>
           ...
           <p className="text-center text-[#A3A697] py-10">V kategórii Čierne čaje zatiaľ nie sú žiadne produkty.</p>
        ) : (
