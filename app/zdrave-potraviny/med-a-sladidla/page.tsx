...
export default function MedPage() {
  ...
  return (
    <main className="min-h-screen bg-[#FAF4E8] text-[#3D4035] flex flex-col">
      ...
      <div className="flex-grow max-w-7xl mx-auto w-full px-6 py-16">
        <section className="text-center max-w-4xl mx-auto mb-12">
          ...
          <p className="text-lg md:text-xl text-[#6B6E56] leading-relaxed">
            Predstavte si nekonečnú rozkvitnutú lúku uprostred horúceho leta.
            Každá lyžička tohto medu v sebe nesie usilovnú prácu včiel, omamnú
            vôňu poľných kvetov a teplo jemného vánku. Je to husté, zlatisté
            pohladenie, ktoré sa tak lahodne a pomaly rozplýva vo vašom
            obľúbenom čaji. Čistá sladkosť prírody, ktorá upokojí myseľ a poteší
            dušu.“
          </p>
        </section>
      ...
      {/* SEO 5 PODSEKCIÍ - MED A SLADIDLÁ */}
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-[#2C2E26]">
              Zistite viac o mede a sladidlách
            </h3>
          </div>
          <div className="space-y-6 text-[#6B6E56] leading-relaxed text-base md:text-lg">
            ...
            >
              <h4 className="text-xl font-semibold text-[#3D4035] mb-3 flex items-center gap-3">
                ...
                Prečo uprednostniť med pred bielym cukrom?
              </h4>
            ...
            >
              <h4 className="text-xl font-semibold text-[#3D4035] mb-3 flex items-center gap-3">
                ...
                Kryštalizácia medu – je to chyba?
              </h4>
