...
export default function KasePage() {
  ...
  useEffect(() => {
    getProductsBySubCategory("Raňajkové kaše")
      .then((data: any) => {
        setProducts(data);
        setIsLoading(false);
      })
      .catch((err: any) => {
        console.error("Chyba pri načítaní raňajkových kaší:", err);
        setIsLoading(false);
      });
  }, []);
  ...
  return (
    <main className="min-h-screen bg-[#FAF4E8] text-[#3D4035] flex flex-col">
      <div className="flex-grow max-w-7xl mx-auto w-full px-6 py-16">
        ...
        <section className="text-center max-w-4xl mx-auto mb-12">
          ...
          <p className="text-lg md:text-xl text-[#6B6E56] leading-relaxed">
            Vyvážené a chutné raňajkové kaše pre dokonalý štart do vášho dňa.
            Rýchla príprava, zdravé zloženie a energia na celé predpoludnie.
          </p>
        </section>
        ...
        {isLoading ? (
          ...
          <p className="text-center text-[#A3A697] py-10">
            V kategórii Raňajkové kaše zatiaľ nie sú žiadne produkty.
          </p>
        ) : (
          <>
            {/* Zoraďovací panel */}
      ...
      {/* SEO 5 PODSEKCIÍ - RAŇAJKOVÉ KAŠE */}
          ...
          <div className="space-y-6 text-[#6B6E56] leading-relaxed text-base md:text-lg">
            ...
            >
              <h4 className="text-xl font-semibold text-[#3D4035] mb-3 flex items-center gap-3">
                ...
                Aké obilniny a základy sú najlepšie
              </h4>
            ...
            >
              <h4 className="text-xl font-semibold text-[#3D4035] mb-3 flex items-center gap-3">
                ...
                Tipy na dochutenie (ovocie, orechy, med)
              </h4>
            ...
            >
              <h4 className="text-xl font-semibold text-[#3D4035] mb-3 flex items-center gap-3">
                ...
                Vhodné aj pri diétach a intoleranciách
              </h4>
