...
export default async function ProductDetail({
  ...
  return (
    <main className="min-h-screen bg-[#F9F8F6] text-[#3D4035] flex flex-col">
      {/* HLAVIČKA (Iba Logo a Ikonky napravo) */}
      <header className="w-full p-6 border-b border-[#E8E6DF] bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          
          {/* Logo */}
          <Link href="/" className="text-3xl md:text-4xl font-bold tracking-widest text-[#5C6B46] hover:opacity-90 transition-opacity">
            TREFIWA
          </Link>
