...
export default function Header() {
    ...
    <header className="w-full bg-white flex flex-col sticky top-0 z-20 shadow-md">
            ...
            <div className="relative group p-2 md:px-3 rounded-xl hover:bg-[#F2F1EC] transition-all duration-300 cursor-pointer">
              <div className="flex items-center space-x-3">
                ...
                <div className="hidden md:flex flex-col text-left leading-tight">
                  <span className="font-bold text-sm text-[#3D4035] group-hover:text-[#5C6B46] transition-colors">{user.name}</span>
                  <span className="text-xs text-[#8A9A5B] font-medium group-hover:text-[#5C6B46] transition-colors">Môj účet</span>
                </div>
              </div>
              ...
              <div className="absolute right-0 top-full mt-2 w-64 opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 ease-out z-50">
                <div className="bg-white text-[#3D4035] shadow-xl rounded-xl overflow-hidden flex flex-col border border-[#E8E6DF] font-medium">
                  ...
                  <div className="px-5 py-3 bg-[#F9F8F6] border-b border-[#E8E6DF]">
                    <span className="block text-xs text-[#A3A697]">Prihlásený ako:</span>
                    <span className="block text-xs font-bold text-[#5C6B46] truncate">{user.email}</span>
                  </div>
                  
                  <Link href="/ucet/objednavky" className="px-5 py-3.5 hover:bg-[#F2F1EC] hover:text-[#5C6B46] hover:pl-6 text-sm border-b border-[#E8E6DF] transition-all duration-300">Objednávky</Link>
                  <Link href="/ucet/fakturacne-udaje" className="px-5 py-3.5 hover:bg-[#F2F1EC] hover:text-[#5C6B46] hover:pl-6 text-sm border-b border-[#E8E6DF] transition-all duration-300">Fakturačné údaje</Link>
                  <Link href="/ucet/dorucovacie-adresy" className="px-5 py-3.5 hover:bg-[#F2F1EC] hover:text-[#5C6B46] hover:pl-6 text-sm border-b border-[#E8E6DF] transition-all duration-300">Doručovacie adresy</Link>
                  <Link href="/ucet/nastavenia" className="px-5 py-3.5 hover:bg-[#F2F1EC] hover:text-[#5C6B46] hover:pl-6 text-sm border-b border-[#E8E6DF] transition-all duration-300">Nastavenia a bezpečnosť</Link>
      ...
      <div className="bg-[#5C6B46] text-white">
        <nav className="max-w-7xl mx-auto px-6 flex flex-wrap gap-x-8 text-sm font-semibold uppercase tracking-widest items-center">
          ...
          <div className="relative group py-4">
            <div className="relative group py-4">
  {/* Hlavné tlačidlo "Zdravé potraviny" so šípkou (nerobí presmerovanie, len otvára menu) */}
  <span className="hover:text-[#D5D3C9] transition-colors duration-300 flex items-center gap-1.5 cursor-pointer">
    Zdravé potraviny
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-3 h-3 transform transition-transform duration-300 group-hover:-rotate-180">
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
  ...
  {/* Vyskakovacie roletové menu */}
  <div className="absolute left-0 top-full w-56 opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 ease-out z-50">
    <div className="bg-white text-[#3D4035] shadow-xl rounded-b-lg overflow-hidden flex flex-col border border-[#E8E6DF] border-t-0 font-medium tracking-wide">
      
      <Link href="/zdrave-potraviny/orechy-a-semienka" className="px-5 py-3.5 hover:bg-[#F2F1EC] hover:text-[#5C6B46] hover:pl-6 text-xs border-b border-[#E8E6DF] transition-all duration-300">
        Orechy a semienka
      </Link>
      
      <Link href="/zdrave-potraviny/sladidla" className="px-5 py-3.5 hover:bg-[#F2F1EC] hover:text-[#5C6B46] hover:pl-6 text-xs border-b border-[#E8E6DF] transition-all duration-300">
        Med a sladidlá
{/* --- SPODNÉ ZELENÉ MENU (Kategórie) --- */}
      <div className="bg-[#5C6B46] text-white">
        <nav className="max-w-7xl mx-auto px-6 flex flex-wrap gap-x-8 text-sm font-semibold uppercase tracking-widest items-center">
          ...
          <div className="relative group py-4">
            ...
            <div className="absolute left-0 top-full w-56 opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 ease-out z-50">
              <div className="bg-white text-[#3D4035] shadow-xl rounded-b-lg overflow-hidden flex flex-col border border-[#E8E6DF] border-t-0 font-medium tracking-wide">
                ...
                <Link href="/zdrave-potraviny/kase" className="px-5 py-3.5 hover:bg-[#F2F1EC] hover:text-[#5C6B46] hover:pl-6 text-xs transition-all duration-300">
                  Raňajkové kaše
                </Link>
              </div>
            </div>
