...
export default function CajoveLyzickyPage() {
  ...
  useEffect(() => {
    // ⚠️ Skontroluj si, či máš kategóriu v DB s dĺžňami ("Čajové lyžičky")
    getProductsBySubCategory("Čajové lyžičky")
      ...
      .catch((err: any) => {
        console.error("Chyba pri načítaní čajových lyžičiek:", err);
        setIsLoading(false);
      });
  }, []);
  ...
  return (
    <main className="min-h-screen bg-[#F9F8F6] text-[#3D4035] flex flex-col">
      <div className="flex-grow max-w-7xl mx-auto w-full px-6 py-16">
        ...
        <section className="text-center max-w-4xl mx-auto mb-12">
          ...
          <p className="text-lg md:text-xl text-[#6B6E56] leading-relaxed">
            ...
            relax a pokoj. Tichý cinkot a tanec v šálke spríjemňuje chvíle
            relaxu.
          </p>
        </section>
        ...
        {isLoading ? (
          ...
          <p className="text-center text-[#A3A697] py-10">
            V kategórii Čajové lyžičky zatiaľ nie sú žiadne produkty.
          </p>
        ) : (
          <>
            {/* Zoraďovací panel */}
      ...
      {/* SEO 5 PODSEKCIÍ ČAJOVÝCH LYŽIČIEK */}
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-xs font-bold uppercase tracking-widest text-[#8A9A5B] block mb-2">
              Drobný detail s veľkým významom
            </span>
            <h3 className="text-3xl md:text-4xl font-bold text-[#2C2E26]">
              Zistite viac o čajových lyžičkách
            </h3>
          </div>
          <div className="space-y-12 text-[#6B6E56] leading-relaxed text-base md:text-lg">
            ...
            >
              <h4 className="text-xl font-semibold text-[#3D4035] mb-3 flex items-center gap-3">
                ...
                Prečo záleží na tvare a materiáli?
              </h4>
            ...
            >
              <h4 className="text-xl font-semibold text-[#3D4035] mb-3 flex items-center gap-3">
                ...
                Správna starostlivosť o povrch
              </h4>
            ...
            >
              <h4 className="text-xl font-semibold text-[#3D4035] mb-3 flex items-center gap-3">
                ...
                Krásny doplnok k darčekovému baleniu
              </h4>
