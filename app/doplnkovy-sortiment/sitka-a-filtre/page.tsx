...
export default function SitkaaFiltrePage() {
  ...
  useEffect(() => {
    // Ak sa kategória v databáze volá inak, prepíš to tu
    getProductsBySubCategory("Sitká a filtre")
      ...
      .catch((err: any) => {
        console.error("Chyba pri načítaní sitiek a filtrov:", err);
        setIsLoading(false);
      });
  }, []);
      ...
      <div className="flex-grow max-w-7xl mx-auto w-full px-6 py-16">
        ...
        <section className="text-center max-w-4xl mx-auto mb-12">
          ...
          <p className="text-lg md:text-xl text-[#6B6E56] leading-relaxed">
            ...
            do dlane, v šálke iba chuť a vôňa ostane.
          </p>
        </section>
        ...
        {isLoading ? (
          ...
          <p className="text-center text-[#A3A697] py-10">
            V kategórii Sitká a filtre zatiaľ nie sú žiadne produkty.
          </p>
        ) : (
          <>
            {/* Zoraďovací panel */}
